...
<center>
    ...
    src="../../figures/05/5_spectral_decomposition.png" width=400> 
    <br>
...
<center>
    <img style="border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="../../figures/05/5_graph_conv.png" width=400> 
    <br>
    <div style="color:orange;
    display: inline-block;
    color: #999;
...
<center>
    <img style="border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="../../figures/05/5_graphsage_visual.png" width=400> 
    <br>
    <div style="color:orange;
    display: inline-block;
    color: #999;
...
<center>
    <img style="border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="../../figures/05/5_graphsage_algorithm.png" width=400> 
    <br>
    <div style="color:orange;
    display: inline-block;
    color: #999;
