...
<center>
    ...
    src="../../figures/03/3_neutral-network-diagram.png"> 
    <br>
...
<center>
    <img style="border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="../../figures/03/3_activation_functions.png"> 
    <br>
    <div style="color:orange;
    display: inline-block;
    color: #999;
...
<center>
    <img style="border-radius: 0.3125em;
    box-shadow: 0 2px 4px 0 rgba(34,36,38,.12),0 2px 10px 0 rgba(34,36,38,.08);" 
    src="../../figures/03/3_model_complexity.png"> 
    <br>
    <div style="color:orange;
    display: inline-block;
    color: #999;
